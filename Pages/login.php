...
<html lang="en"> <!-- Language is specified to increase SEO. -->
    ...
    <head> <!-- Content invisible to the user -->
        <title>Log in - UCLan Student's Union Shop</title> <!-- JavaScript will be used to edit the name of the tab -->
        <link type="text/css" rel="stylesheet" href="../Stylesheets/global.css"> <!-- Style the header & footer of the page -->
        <link type="text/css" rel="stylesheet" href="../Stylesheets/login.css"> <!-- The unique CSS file for this page -->
    ...
    <body> <!-- Content in the body is visible to the user -->
        <div id="content">
            ...
            <div id="main"> <!-- The DOM will be manipulated to display content in this container. -->
                <h1>Sign up</h1>
                <p>An account is required to purchase items from the UCLan Student's Union Shop! You can sign up for an account using the form below.</p>
                <form> <!-- The form will mostly be created in HTML, as it is a static form -->
                    ...
                    <br>
                    <input id="submitRequest" type="submit" value="Submit">
                </form>
            </div>
        </div>
